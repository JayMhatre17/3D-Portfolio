	...
	return (
		<div className="md:m-12 md:px-48 flex flex-col sm:flex-row gap-10 overflow-hidden">
			...
			>
				...
				<form
					action="https://getform.io/f/qbloppwa"
					method="POST"
				...
				>
					...
					<input
						...
						className="bg-tertiary p-4 text-white border rounded-lg font-medium"
						required
					/>
					...
					<input
						...
						className="bg-tertiary p-4 text-white rounded-lg border font-medium"
						required
					/>
					...
					<div className="space-x-4">
						<button
							type="submit"
							className="bg-tertiary py-3 px-8 w-fit rounded-lg text-white font-bold shadow-md shadow-primary "
						>
